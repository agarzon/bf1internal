	...
	for (const char* line_start = file_data; line_start < buf_end; )
	{
		...
		else if (settings)
		{
			...
			if (sscanf(line_start, "Pos=%f,%f", &x, &y) == 2)
				...
				Features::Radar = j;
			else if (sscanf(line_start, "RadarDistance=%d\n", &j) == 1)
				Features::RadarDistance = j;
			...
			else if (sscanf(line_start, "key_Aim1=%d\n", &j) == 1) key_Aim1 = j;
			else if (sscanf(line_start, "key_Aim2=%d\n", &j) == 1) key_Aim2 = j;
		}
...
static void SaveSettings()
{
	...
	fprintf(f, "Radar=%d\n", Features::Radar);
	fprintf(f, "RadarDistance=%d\n", Features::RadarDistance);
	...
	fprintf(f, "key_Aim1=%d\n", key_Aim1);
	fprintf(f, "key_Aim2=%d\n", key_Aim2);
	fclose(f);
}
