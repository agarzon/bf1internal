...
#define OFFSET_GAMERENDERER			0x143616d98//0x14360ed98//0x14368E2A0
#define OFFSET_DXRENDERER			0x143617298//0x14360f298//0x14368E798
#define BORDER_INPUT_NODE			0x1430C3D58//0x1430BBD58//0x143112D58 not used; if dont have this offset BORDER_INPUT_NODE in DX11.h disable: pfh = new CVMTHookManager64((QWORD**)BorderInputNode::Get()->input_node);
#define OFFSET_GAMECONTEXT_2		0x1434272d0//0x14341f2d0//0x14349E810  //tova e CLIENT_GAME_CONTEXT
